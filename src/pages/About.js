...
function About() {
  return (
    <div className="about">
      ...
      <p>Our mission is to drive research and innovation across various domains.</p>
...
We provide the best learning experience in current trending technologies through facilitators who are continuous learners with the highest potential and empower others to do the same. Our practical approach encapsulates individuals in excelling through real-time strategies and the great promise to businesses in finding the best prospects who can set a benchmark to improve the quality of the businesses. The mission involves <b></b>
<b>1.</b>Developing the state-of-the-art benchmark in data science,<br></br>
<b>2.</b>Transforming all fields, professions, and sectors through the application of data science.
</p>
<h1>Our Journey</h1>
<h2>Humble beginnings</h2>
<p>Innomatics Research Labs came a long way since those humble beginnings in 2018 intending to ‘Transform the Career and Lives’ of the individuals in the competitive world and upskilling their career, also and creating a balance between the learning and implementing the real-time cases in businesses.</p>
<h2>Transforming careers</h2>
<p>Innomatics believe and follow the practical approach rather than the theoretical one. The practical and real-time applications explained to make every individual face industry challenges.</p>
<h2>
Scaling to new heights</h2>
<p>We were awarded as one of the most prominent training institutes in Hyderabad for our cutting-edge training methodologies, spacious classrooms to practice, and expert trainers.</p>
<h2>Expanding horizons</h2>
<p>Innovation is our tradition; We want to mark our footprints in almost every sector, so we have introduced courses in Investment Banking, AWS, and Microsoft Azure.</p>
<h2>Stepping to online</h2>
<p>We encourage learning, be it online or classroom. We believe that upskilling is necessary for every aspect of life. Keeping this thought in mind, we have introduced online courses that encourage self-paced and ease of learning..</p>
<h2>And the mission continues</h2>
<p>With 40+ trainers hailing from leading organizations such as Apple and Microsoft, 50+ batches and 1500 students have been trained and placed in top-notch companies.</p>
    </div>
  );
}
